...
def make_noises(num_layers):
    ...
    for layer_idx in range(num_layers):
        ...
        # noises.append(torch.randn(*shape))
        noises.append(torch.tensor(noise, dtype=torch.float32))
    return noises
...
class StyleGAN2GeneratorClean(nn.Module):
    ...
    def __init__(
        ...
        self.noises = make_noises(self.num_layers)
